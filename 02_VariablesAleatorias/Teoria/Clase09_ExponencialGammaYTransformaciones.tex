...
$$f_Y(y) = f_X\!\left(\frac{y-b}{a}\right)\left|\frac{1}{a}\right| = \frac{1}{|a|\sigma\sqrt{2\pi}}\exp\left(-\frac{\left(\frac{y-b}{a}-\mu\right)^2}{2\sigma^2}\right) = \frac{1}{|a|\sigma\sqrt{2\pi}}\exp\left(-\frac{(y-(a\mu+b))^2}{2(a\sigma)^2}\right).$$
