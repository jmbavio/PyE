...
\begin{frame}{Cronograma tentativo}
\small
\begin{center}
\begin{tabular}{@{}lll@{}}
\toprule
\textbf{Unidad} & \textbf{Clases} & \textbf{Fechas} \\
\midrule
Presentación & Clase 0 & 18/ago \\
1. Espacios de probabilidad & Clase 01--04 & 18/ago -- 27/ago \\
2. Variables aleatorias & Clase 05--09 & 1/sep -- 15/sep \\
3. Vectores aleatorios & Clase 10--13 & 17/sep -- 29/sep \\
4. Función generadora de momentos & Clase 14--18 & 1/oct -- 15/oct \\
\midrule
\multicolumn{3}{l}{\textbf{1\textsuperscript{er} parcial (tentativo, a confirmar) --- última semana de octubre}} \\
\midrule
5. Muestras aleatorias y distribuciones & Clase 19--20 & 20/oct -- 22/oct \\
6. Estimación de parámetros & Clase 21--24 & 27/oct -- 5/nov \\
7. Prueba de hipótesis & Clase 25--28 & 10/nov -- 19/nov \\
8. Modelos lineales & Clase 29--32 & 24/nov -- 3/dic \\
\multicolumn{3}{l}{\textbf{2\textsuperscript{do} parcial y recuperatorio (tentativo) --- diciembre}} \\
\bottomrule
\end{tabular}
\end{center}
\normalsize
\vspace{0.5em}
{\footnotesize Cronograma proyectado según martes/jueves desde el 18/8; sujeto a ajustes por feriados y a las fechas definitivas de parciales.}
\end{frame}
