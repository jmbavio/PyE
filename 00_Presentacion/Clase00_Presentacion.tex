...
\begin{itemize}
\item Se toman \textbf{3 parciales} durante el cuatrimestre.
\item Fechas: a confirmar con la asistente de cátedra.
...
Promedio de los 3 parciales \textbf{mayor a 80} $\Rightarrow$ promociona la materia sin final.
\end{block}
\begin{block}{Regular}
Con los 3 parciales aprobados (60 o más, incluyendo recuperatorio si hizo falta) pero promedio $\le 80$: queda regular y rinde final.
\end{block}
\end{frame}
...
\item 3 parciales (60 aprueba c/u, recuperatorio único, promedio $>80$ promociona).
