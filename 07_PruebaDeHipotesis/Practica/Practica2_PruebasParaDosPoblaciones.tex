...
\[
t=\frac{(48.3-45.1)-0}{2.629\sqrt{1/11+1/13}}=\frac{3.2}{2.629\times0.4157}=\frac{3.2}{1.093}=2.93.
\]

Como $2.93>2.074$, se \textbf{rechaza} $H_0$: hay evidencia de diferencia significativa entre las duraciones medias.

\textbf{(b)} $\displaystyle IC_{95\%}(\mu_X-\mu_Y)=3.2\pm2.074\times1.093=3.2\pm2.267=(0.93;\,5.47)$.
