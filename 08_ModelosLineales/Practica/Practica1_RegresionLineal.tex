...
\begin{solucion}
$CME = SCE/(n-2) = 0.943/6 \approx 0.1572$, $\widehat{ee}(\hat\beta_1)=\sqrt{CME/S_{xx}}=\sqrt{0.1572/1050.0}\approx0.01224$.
...
\hat y = 1.331+0.605\,x.
\]
$SCR=\hat\beta_1S_{xy}=0.605(36.3)\approx21.962$; $SCE=SCT-SCR\approx22.142-21.962=0.180$; $R^2\approx21.962/22.142\approx0.9918$: el modelo explica cerca del $99.2\%$ de la variabilidad del costo de mantenimiento.
