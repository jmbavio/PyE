...
\begin{axis}[width=9cm,height=5.5cm,
  ...
  ymin=17,ymax=32, tick label style={font=\scriptsize}, label style={font=\small},
  boxplot/draw direction=y]
\addplot+[boxplot, fill=blue!25] table[row sep=\\,y index=0]{
data\\ 23\\ 25\\ 21\\ 24\\ 22\\
};
\addplot+[boxplot, fill=blue!25] table[row sep=\\,y index=0]{
data\\ 27\\ 29\\ 26\\ 28\\ 30\\
...
\end{tikzpicture}
\end{center}
El gráfico de cajas confirma lo que sugiere la tabla ANOVA: las dispersiones dentro de cada máquina son comparables (homocedasticidad razonable), mientras que las posiciones (medianas) difieren notoriamente entre máquinas, en particular B se separa claramente del resto.
\end{frame}
