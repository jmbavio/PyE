...
\begin{frame}{Hacia una definición rigurosa}
\begin{alertblock}{El problema}
Ninguna de las tres nociones anteriores (clásica, frecuencial, subjetiva) es una definición matemática rigurosa y única. Necesitamos una \textbf{axiomática} que las englobe a todas como casos particulares de un mismo modelo formal.
\end{alertblock}
\end{frame}
...
\begin{frame}{Los axiomas: una observación}
...
\begin{frame}{Propiedad 4: demostración (continuación)}
\begin{proof}
...
\begin{frame}{Propiedad 5: subaditividad}
...
\begin{frame}{Propiedad 6: continuidad de la probabilidad}
